...
\
	...
	n_dstwidth = ( ( ( ( n_columns + blit_sxdivide - 1 ) / blit_sxdivide ) * ( /*blit_dbpp*/16 / 8 ) * blit_xmultiply ) + 3 ) / 4; \
...
//	else			{	blit_dbpp = dbpp;	}
	...
	{
		if( blit_sbpp == 16/*blit_dbpp*/ && !blit_swapxy && !blit_flipx && blit_xmultiply == 1 && blit_dxdivide == 1 )
		{
// bitblit_psp_direct
