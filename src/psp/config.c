...
/* from sound.c */
int enable_sound;
extern int soundcard, usestereo,  sampleratedetect;
...
//TMK ADD
	if ((setting.screensize == SCR_STRETCH)
	  ...
	  ||(setting.screensize == SCR_ROT_STRETCH)
	  ||(setting.screensize == SCR_ROT_STRETCH_ACPECT))
		stretch =1;
	else
		stretch =0;
...
//		config_autoror =0;
	...
	switch((setting.sound_rate)&3){
	case 0:	options.samplerate = 44100;	break;
	case 1:	options.samplerate = 22050;	break;
	case 2:	options.samplerate = 11025;	break;
	case 3:	options.samplerate =  5512;	break;
	}
