...
//	MDRV_CPU_ADD(M68000, NA_MASTER_XTAL/4) /* 12[MHz]? (built on real boads can 12MHz) */
...
extern UINT8 fa_tempo_cheat;

/* NA1 exvania */
static MACHINE_DRIVER_START( na1e )
	MDRV_IMPORT_FROM(na_base)
	fa_tempo_cheat=1;
	/* video hardware */
	MDRV_VISIBLE_AREA(8, 38*8-1-8, 4*8, 32*8-1)/*[exvania only]*/
MACHINE_DRIVER_END
...
GAMEX( 1992,cgangpzl, 0,		na1w, na1_joy,	cgangpzl, ROT0, "Namco", "1992 NA1 Cosmo Gang the Puzzle (US)", GAME_IMPERFECT_SOUND )
GAMEX( 1992,cgangpzj, cgangpzl, na1w, na1_joy,	cgangpzl, ROT0, "Namco", "1992 NA1 Cosmo Gang the Puzzle (Japan)" "コズモギャング ザ パズル", GAME_IMPERFECT_SOUND )
GAMEX( 1992,exvania,  0,		na1e, na1_joy,	exbania,  ROT0, "Namco", "1992 NA1 Exvania (Japan)""イクスバーニア", GAME_IMPERFECT_SOUND )
