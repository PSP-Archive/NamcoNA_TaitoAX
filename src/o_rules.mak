...
CPU=$(strip $(findstring N68000@,$(CPUS)))
ifneq ($(CPU),)
OBJDIRS += $(OBJ)/cpu/n68000
CPUDEFS += -DHAS_N68000=1
CPUOBJS +=	$(OBJ)/cpu/n68000/m68kcpu.o $(OBJ)/cpu/n68000/m68kmame.o
else
...
CPUOBJS +=	$(OBJ)/cpu/m68000/m68kcpu.o $(OBJ)/cpu/m68000/m68kmame.o
